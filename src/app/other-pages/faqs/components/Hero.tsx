  ...
  return (
    <section className="pt-lg-8">
      <Container className="pt-4 pt-lg-0">
        <Row className="g-4 g-xl-6 align-items-center">
          <Col md={6}>
            <h1 className="mb-4">{t('faqContent.heading')}</h1>
            <p className="mb-0">{t('faqContent.subheading')}</p>

            <Col xs={10} className="mt-4">
              <Form className="position-relative">
                <FormControl size="lg" className="bg-light ps-6" type="search" placeholder={t('faqContent.searchPlaceholder')} />
                <button className="btn bg-transparent px-3 py-0 position-absolute top-50 start-0 translate-middle-y" type="submit">
          ...
          <Col md={6}>
            <svg viewBox="0 0 502.3 300.7">
              ...
              <path
                className="fill-mode opacity-9"
                d="M161.9,242.7c-0.3,3.5-0.1,7.1-0.5,10.6c-0.4,4.5-1.6,9.8-5.8,12.2c-3.5,2.2-8.5,2-12.6,2.2 c-3.5,0.1-6.9-0.3-10.3-0.5c-0.7,0-0.7,0.9,0,0.9c3.8,0.3,7.6,0.7,11.4,0.5c4.2-0.1,9.2-0.1,12.8-2.7c7.1-5.2,5.6-15.6,6.1-23.2 C162.9,242.1,161.9,242.1,161.9,242.7z"
              />
              <path
                className="fill-mode opacity-9"
                d="M27.7,213.1l0.7-14.7c-1.5,0-0.5,0-2,0c-1.6,0-3.3,0-4.7,0.8c-1.9,0.9-3,3.4-2.6,5.4s2,3.5,3.7,4.7 C24.4,210.7,26.3,211.7,27.7,213.1z"
              />
              <path
                className="fill-mode opacity-9"
                d="M169.8,237c-0.9,0.7-1.5,1.8-1.4,2.8c0.1,1.1,0.9,2,1.9,2.4c0.3,0.1,0.5-0.1,0.7-0.4c0.1-0.3-0.1-0.5-0.4-0.7 c-0.7-0.3-1.1-0.8-1.2-1.5c-0.1-0.7,0.3-1.5,0.8-1.9c0.3-0.1,0.3-0.4,0.1-0.7C170.3,237,169.9,236.9,169.8,237z"
              />
              <path
                className="fill-mode opacity-9"
                d="M175.3,233.5c-1.2,0.7-1.8,2-1.5,3.4s1.5,2.4,2.7,2.7c0.7,0.1,0.9-0.8,0.3-0.9c-0.9-0.3-1.8-0.9-2-2 c-0.1-0.8,0.3-1.9,0.9-2.3C176.4,234,175.9,233.2,175.3,233.5z"
              />
              <path
                className="fill-mode opacity-9"
                d="M174.3,224.1c-0.9,1.2-1.6,2.7-0.9,4.2c0.3,0.5,0.7,1.2,1.4,1.5c0.3,0.1,0.7,0.3,1.1,0.3c0.3,0,0.7,0,0.8,0.3 c0.3,0.1,0.5,0,0.7-0.1c0.1-0.3,0-0.5-0.1-0.7c-0.5-0.4-1.1-0.3-1.8-0.4c-0.4-0.1-0.8-0.5-1.1-0.9c-0.5-1.1,0-2.3,0.7-3.1 c0.1-0.3,0.3-0.5,0-0.7C174.8,223.9,174.5,223.9,174.3,224.1z"
              />
              <path
                className="fill-mode opacity-9"
                d="M166.2,214.4c-0.4,1.2-0.1,2.6,0.7,3.4c0.8,0.9,2.2,1.2,3.3,0.9c0.3,0,0.4-0.4,0.4-0.7 c-0.1-0.3-0.4-0.4-0.7-0.4c-0.8,0.1-1.8-0.1-2.3-0.8c-0.3-0.3-0.4-0.7-0.5-1.2v-0.1v-0.1c0-0.1,0-0.3,0-0.4v-0.1v-0.1 c0-0.1,0.1-0.3,0.1-0.4c0.1-0.3-0.1-0.5-0.4-0.7C166.5,214,166.2,214.1,166.2,214.4z"
              />
              <path className="fill-mode opacity-9" d="M107.9,105.4c0,0,0.5,7.3,6.4,14.2l0.8-9.1L107.9,105.4z" />
              <path
                className="fill-mode opacity-9"
                d="M128.1,89.5c-0.5,0.7-0.7,1.8-0.4,2.6c0.1,0.5,0.4,0.8,0.8,1.2c0.3,0.3,0.7,0.7,0.5,1.1c-0.1,0.7-1.5,0.1-2,0.3 c-0.8,0-1.6,0.5-1.6,1.4c0,0.7,1.1,0.7,0.9,0c0-0.5,1.2-0.4,1.5-0.3c0.8,0.1,1.9,0,2-1.1c0.1-0.4,0-0.9-0.3-1.4 c-0.3-0.4-0.5-0.8-0.8-1.2c-0.4-0.7-0.4-1.6,0.1-2.3c0.1-0.3,0-0.5-0.1-0.7C128.7,89.1,128.4,89.2,128.1,89.5z"
              />
              <path
                className="fill-mode opacity-9"
                d="M122.4,100.2c-0.3-0.5-0.7-1.1-1.1-1.5c-0.1-0.1-0.3-0.1-0.4-0.1c-0.1,0-0.3,0-0.4,0.1 c-0.1,0.1-0.1,0.3-0.1,0.4c0,0.1,0,0.3,0.1,0.4c0.3,0.1,0.4,0.4,0.5,0.7c0,0,0-0.1-0.1-0.1c0.1,0.3,0.3,0.4,0.4,0.7 c0,0.1,0.1,0.1,0.3,0.3c0.1,0,0.3,0,0.4,0C122.5,100.8,122.5,100.5,122.4,100.2z"
              />
              <path
                className="fill-mode opacity-9"
                d="M450.5,299.9H0.8c-0.4,0-0.8-0.4-0.8-0.8c0-0.4,0.4-0.8,0.8-0.8h449.7c0.4,0,0.8,0.4,0.8,0.8 C451.4,299.5,451,299.9,450.5,299.9z"
              />
              <path
                className="fill-primary"
                d="M393.7,88.4c-2.3-6.2-7.1-10.9-12.9-14.1c-3.3,1.2-6.4,2.4-9.6,3.7c2.4,2.4,5.2,4.6,8.1,6.4 c-5,2.4-9.6,5.6-14,9.1c0.5,4.1,1.6,8,3.1,11.8c-4.3,1.1-8.4,2.8-12.2,5.3c-0.5,3.9-0.9,7.3-2.6,11c-0.1,0.4-0.3,0.7-0.4,1.1 c1.8-4.7-3.1-10.7,0-14.8c1.6-2,5.2-3,5-5.6c0-0.7-0.3-1.4-0.5-1.9c-1.4-2.7-2.6-5.4-3.9-8.1c3.7-2.6,7.5-4.9,11.3-7.2 c-3-5.2-5.8-10.3-8.4-15.7c-6.1,0.3-12.1,1.8-17.1,5.2c-6.6,4.3-11.3,12.1-10.4,19.9c0.5,5.3,3.5,10,6.5,14.5c3,4.5,6.1,9,7.2,14.1 c1.1,5.2-0.3,11.4-4.9,14.2c1.6,2.3,5.4,3.8,8.3,4.1c2.8,0.3,5.3-0.4,8,0.3c1.8-7.7,6.9-14.7,13.8-18.5c5.2-2.8,11.1-4.1,16-7.3 C393.3,110,397.2,98.2,393.7,88.4z"
              />
              <path
                className="fill-mode opacity-9"
                d="M342,133.2c-0.9-0.1-1.8-0.1-2.6,0c-1.8,0.3-3.1,2.3-4.1,3.7c-1.4,2.2-2.3,4.6-1.8,7.1c0.7,2.6,3.1,4.3,5.7,5.3 s5.3,1.1,7.9,1.6c1.2,0.3,2.4,0.7,3.7,0.4c1.6-0.3,2.8-1.6,3.8-3c1.4-1.8,2.4-3.8,3.3-5.7c0.1-0.4,0.3-0.7,0.3-1.1 c0-0.5-0.4-0.9-0.8-1.2c-3.3-2.8-7.2-4.9-11.4-6C345,133.9,343.5,133.5,342,133.2z"
              />
              <path
                className="fill-mode opacity-9"
                d="M347.1,132.1c1.6-6.2,2.7-12.8,3-19.1c0.4-6.1,0.5-13-0.9-19c-0.5-1.9-1.4-4.1-3.3-5c-1.2-0.7-2.7-0.5-3.4,0.8 c-1.6,3.3,1.5,7.3,4.7,7.9c2,0.3,3.9-0.7,5.7-1.6c1.1-0.7,2.3-1.4,3.5-1.8c0.7-0.1,1.8-0.4,2.4-0.1c1.1,0.5,1.1,1.6,1.4,2.6 c0.9,4.2,4.2,6,8,3.9c2.4-1.2,4.9-3.4,7.7-2.6c3.7,0.9,5,5,3.9,8.4c-0.5,1.8-2.2,4.2-4.3,3.9c-2-0.3-2.4-3.4-1.8-4.9 c0.9-2.2,3.4-2.7,5.2-1.2c1.8,1.4,2,3.7,0.9,5.7c-3.4,6.6-12.9,4.1-18.5,7.5c-2.3,1.4-3.8,3.7-5,6c-1.8,3.3-3.3,6.6-4.7,10 c-0.1,0.4,0.4,0.8,0.7,0.4c1.5-3.3,3-6.5,4.6-9.8c1.6-3.1,3.8-5.8,7.2-7.1c5.2-1.9,12.1-0.7,15.7-5.6c1.2-1.6,1.9-3.9,0.9-5.8 c-0.8-1.6-2.6-3-4.5-2.8c-3.8,0.4-5,5.8-1.9,8c3.9,2.7,6.8-4.3,6.6-7.2c-0.3-4.5-4.7-7.5-8.8-5.8c-2.3,0.9-4.9,3.5-7.6,3.1 c-2.2-0.3-3.1-2.2-3.7-4.1c-0.3-0.8-0.1-2-0.8-2.7c-1.2-1.4-3.7-0.7-5.2,0c-2.7,1.2-5.6,3.8-8.7,2.6c-1.9-0.7-3.9-3.1-3.5-5.3 c0-0.1,0-0.3,0-0.5c0.8-0.4,1.8-0.8,2.6-1.4c0.7,0.1,1.4,1.2,1.8,1.8c0.5,0.8,0.8,1.6,1.1,2.6c1.1,3.8,1.1,8.3,1.1,12.2 c0.1,8.7-0.9,17.4-3.1,25.9C346.3,132.4,347,132.7,347.1,132.1z"
              />
              <path
                className="fill-body"
                d="M340.1,134.3c1.2,0.9,2,2.2,3,3.4c0.9,1.2,1.9,2.2,3.1,3.1c2.6,2.2,5.3,4.1,7.9,6.2c0.4,0.3,0.9-0.3,0.5-0.5 c-2.7-2-5.6-4.1-8.1-6.4c-1.2-1.1-2.3-2.2-3.3-3.4c-0.8-1.1-1.6-2.3-2.8-3.1C340.1,133.4,339.7,134,340.1,134.3z"
              />
              <path
                className="fill-body"
                d="M338,137.4c3.3,4.3,6.9,8.1,11.1,11.5c0.4,0.3,0.9-0.3,0.5-0.5c-4.2-3.3-7.9-7.2-11-11.4 C338.3,136.6,337.8,137,338,137.4z"
              />
              <path
                className="fill-body"
                d="M337.4,142.3c1.2,1.6,2.8,3.1,4.6,4.2c0.4,0.3,0.8-0.4,0.4-0.7c-1.8-1.1-3.3-2.4-4.5-4.1 c-0.1-0.1-0.4-0.1-0.5,0S337.2,142,337.4,142.3z"
              />
              <path
                className="fill-body"
                d="M388.9,85.7c1.9,2.6,2.7,5.7,2.2,8.8c-0.1,0.4,0.7,0.7,0.7,0.1c0.5-3.3-0.3-6.6-2.3-9.4 C389.3,85,388.7,85.3,388.9,85.7z"
              />
              <path
                className="fill-body"
                d="M387.8,89.4c0.7,1.6,1.1,3.5,0.9,5.3c0,0.4,0.7,0.4,0.7,0c0.1-1.9-0.3-3.8-0.9-5.4c-0.1-0.1-0.3-0.3-0.4-0.3 C388,89,387.8,89.2,387.8,89.4z"
              />
              <path
                className="fill-body"
                d="M335.6,96.3c-0.4-6.2,2.4-12.5,7.3-16.4c0.4-0.3-0.1-0.8-0.5-0.5c-5,3.9-8,10.4-7.6,16.8 C334.9,96.7,335.6,96.7,335.6,96.3z"
              />
              <path
                className="fill-body"
                d="M334.1,89.5c0.3-2.2,1.1-4.2,2.4-5.8c0.3-0.4-0.3-0.8-0.5-0.5c-1.5,1.9-2.4,4.1-2.6,6.4 C333.4,90.1,334.1,90.1,334.1,89.5z"
              />
              <path
                className="fill-primary"
                d="M10,268.9c3.1,0,5.7-2.6,5.7-5.7c0-3.1-2.6-5.7-5.7-5.7c-3.1,0-5.7,2.6-5.7,5.7C4.3,266.4,6.9,268.9,10,268.9z"
              />
              <path
                className="fill-mode opacity-9"
                d="M9.6,263.8c-1.8,0-3.3-1.6-3.3-3.7c0-2,1.5-3.7,3.3-3.7c1.8,0,3.3,1.6,3.3,3.7C12.8,262.1,11.4,263.8,9.6,263.8 z M9.6,257.3c-1.4,0-2.4,1.2-2.4,2.8c0,1.5,1.1,2.8,2.4,2.8c1.4,0,2.4-1.2,2.4-2.8C12.1,258.6,11,257.3,9.6,257.3z"
              />
              <path
                className="fill-mode opacity-9"
                d="M172.3,149.5l-9.9-9.9l9.9-9.9l9.9,9.9L172.3,149.5z M163.5,139.7l8.7,8.7l8.7-8.7l-8.7-8.7L163.5,139.7z"
              />
              <path
                className="fill-mode opacity-9"
                d="M183.7,132.1c1.3,0,2.4-1.1,2.4-2.4c0-1.3-1.1-2.4-2.4-2.4c-1.4,0-2.4,1.1-2.4,2.4 C181.3,131,182.4,132.1,183.7,132.1z"
              />
              <path
                className="fill-mode opacity-9"
                d="M201.8,146.4c0,2.6-2,4.6-4.6,4.6c-2.6,0-4.6-2-4.6-4.6c0-2.6,2-4.6,4.6-4.6 C199.8,141.8,201.8,143.8,201.8,146.4z"
              />
              <path
                className="fill-primary"
                d="M412.6,141.1c0,3.8-3.4,6.9-7.7,6.9c-4.3,0-7.7-3.1-7.7-6.9c0-3.8,3.4-6.9,7.7-6.9 C409.2,134.2,412.6,137.3,412.6,141.1z"
              />
              <path
                className="fill-mode opacity-9"
                d="M384.1,159.5c-3.3,0-6-2.7-6-6c0-3.3,2.7-6,6-6s6,2.7,6,6C389.9,157,387.3,159.5,384.1,159.5z M384.1,148.6 c-2.8,0-5,2.3-5,5c0,2.8,2.3,5,5,5c2.8,0,5-2.3,5-5C389.1,150.9,386.8,148.6,384.1,148.6z"
              />
              <path
                className="fill-mode opacity-9"
                d="M403.5,144.6L393,134.2l10.4-10.4l10.4,10.4L403.5,144.6z M394.2,134.2l9.2,9.2l9.2-9.2l-9.2-9.2L394.2,134.2z"
              />
              <path
                className="fill-mode opacity-9"
                d="M407,160.8c0,1.6-1.4,3-3,3c-1.6,0-3-1.4-3-3c0-1.6,1.4-3,3-3C405.6,157.8,407,159.1,407,160.8z"
              />
              <path
                className="fill-mode opacity-9"
                d="M289.9,263.4c-3.3,0-6-2.7-6-6c0-3.3,2.7-6,6-6s6,2.7,6,6C295.7,260.8,293.1,263.4,289.9,263.4z M289.9,252.4 c-2.8,0-5,2.3-5,5c0,2.8,2.3,5,5,5c2.8,0,5-2.3,5-5S292.6,252.4,289.9,252.4z"
              />
              <path className="fill-mode opacity-9" d="M312.8,264.6c0,1.6-1.4,3-3,3s-3-1.4-3-3s1.4-3,3-3S312.8,263,312.8,264.6z" />
              <path
                className="fill-mode opacity-9"
                d="M289.7,277.3c2.5,0,4.5-2,4.5-4.5s-2-4.5-4.5-4.5c-2.5,0-4.5,2-4.5,4.5S287.3,277.3,289.7,277.3z"
              />
              <path
                className="fill-body"
              ...
              />
              <path className="fill-mode opacity-9" d="M436.6,290.9l-111.4,5.2l-1.4-5l58.4-89.4l112.8-0.1l5,2.8L436.6,290.9z" />
              <path className="fill-body" d="M439.8,294.7L327.1,295l58.2-89.4l112.8-0.1L439.8,294.7z" />
              <path
                className="fill-mode opacity-9"
                d="M384.7,204.5l115.2-0.1l-59.7,91.5L325,295.9L384.7,204.5z M496.1,206.4l-110.3,0.1l-57,87.4l110.3-0.1 L496.1,206.4z"
              />
              <path className="fill-mode opacity-9" d="M290.4,299.1l153.5-0.1v-8.1l-148.2,0.1c-3,0-5.3,2.4-5.3,5.3V299.1z" />
              <path
                className="fill-mode opacity-9"
                d="M419.9,250.7c-1.6,2.6-1.8,5.6-0.1,6.5c1.5,0.9,4.2-0.3,5.8-2.8c1.6-2.6,1.8-5.6,0.1-6.5 C424.1,246.8,421.5,248,419.9,250.7z"
              />
            </svg>
          </Col>
        </Row>
