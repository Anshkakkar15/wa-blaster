...
import decorationPattern from '@/assets/images/elements/decoration-pattern.svg'
...
const Hero = () => {
  return (
    <section className="position-relative overflow-hidden pb-0 pt-xl-9">
      <div className="position-absolute top-0 start-0 ms-n7 d-none d-xl-block">
        <Image src={decorationPattern} alt="" />
      </div>

      <figure className="position-absolute top-0 end-0 me-n4 mt-n7 d-none d-xl-block">
        <svg className="fill-mode opacity-1" width="775px" height="834px" viewBox="0 0 775 834" xmlSpace="preserve">
        ...
        <Row className="g-xl-5">
          <Col xl={7} className="mb-5 mb-xl-0">
            <div className="pe-xxl-4">
              <span className="heading-color d-inline-block bg-light small rounded-3 px-3 py-2">🤩 Award-winning digital services</span>
              <h1 className="mt-3 lh-base">
                Scale Your Outreach with AI-Powered&nbsp;
                <br />
                <span className="cd-headline clip big-clip is-full-width text-primary mb-0 d-block d-xxl-inline-block">
                  <ReactTyped strings={['WhatsApp Automation']} className="typed" typeSpeed={200} backSpeed={50} loop />
                </span>
              </h1>
              <p className="mb-0 mt-4 mt-md-5">
                Send Bulk whatsApp Messages efforting with AI-Powered Templates, smart contact management and enterprises guide privacy. Everything
                you need to grow your communication at scale-securely and efficiently.
              </p>
              <Col as={Form} md={10} className="bg-body border rounded-2 position-relative p-2 mt-4 mt-md-5">
                <InputGroup>
                  <FormControl className="focus-shadow-none border-0 me-1" type="email" placeholder="Enter your email address" />
                  <Button variant="dark" type="button" className="rounded-2 mb-0">
                    Start trial!
                  </Button>
                </InputGroup>
              </Col>
                ...
                <Col md={6} className="mb-5 mb-md-0">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-3">
                      ...
                      <p className="mb-0">We&apos;re always here to help</p>
                    </div>
                  </div>
                </Col>
                <Col md={6}>
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-3">
                      ...
                      <p className="mb-0">You are in safe hand</p>
                    </div>
                  </div>
                </Col>
              </Row>
          ...
          <Col md={10} xl={5} className="position-relative mx-auto mt-7 mt-xl-0">
            <figure className="position-absolute top-0 start-0 translate-middle mt-2">
              <svg width="124.2px" height="76.9px" viewBox="0 0 124.2 76.9" xmlSpace="preserve">
                <path
                  className="fill-mode"
            ...
            <Image src={bg1Img} className="rounded" alt="hero-img" />
            ...
            <div className="d-inline-block bg-dark rounded-4 position-absolute start-0 bottom-0 mb-md-4 ms-md-n5 p-3">
              ...
              <p className="text-white mb-0 mt-2">Total visitors per month</p>
            </div>
